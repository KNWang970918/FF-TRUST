...
dir_path = '/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/sleep-edfx/sleep-cassette/'
...
for psg_f_name, label_f_name in tqdm(psg_label_f_pairs):
    ...
    with open('/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/sleep-edfx/sleep-edf-npy-filter40/' + psg_f_name[3:6] + 'seq.npy', 'wb') as f:
        np.save(f, epochs_seq)
    with open('/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/sleep-edfx/sleep-edf-npy-filter40/' + label_f_name[3:6] + 'label.npy', 'wb') as f:
