...
dir_path = '/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/P2018/training'

seq_dir = '/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/P2018/seq'
label_dir = '/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/P2018/labels'

subject_dirs = sorted(
    d for d in os.listdir(dir_path)
    if os.path.isdir(os.path.join(dir_path, d)))[:150]

psg_label_f_pairs = []
for item in subject_dirs:
    # ✅ 正确拼路径：/training/<item>/<item>.mat, /training/<item>/<item>.arousal
    psg_label_f_pairs.append((
        os.path.join(dir_path, item, f'{item}.mat'),
        os.path.join(dir_path, item, f'{item}.arousal'),
    ))
