...
dir_path = '/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/HMC/recordings'

seq_dir = '/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/HMC/seq'
label_dir = '/cvhci/temp/knwang/SleepDG-main/datasets/Datasets/HMC/labels'
