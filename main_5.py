...
def main():
    ...
    parser.add_argument('--model_dir', type=str, default='/cvhci/temp/knwang/SleepDG-main/checkpoints/DeepSleepNet/1.0ce,0.5coral,0.5ae,0nr sym')
    ...
    parser.add_argument('--lambda_infomax', type=float, default=0,
                        help='InfoMax regularization weight for Forward-Free loss')

    parser.add_argument('--lambda_elr', type=float, default=0)
    parser.add_argument('--elr_momentum', type=float, default=0)
